  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <Button size="small" variant="contained" endIcon={<AddCircleIcon />} sx={{px: 2}} onClick={() => {props.handleOpenModal()}}>
          Agregar
        </Button>
      )}
    </Toolbar>
...
function TransactionsTable({ transactions, handleOpenModal }) {
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">
                      $ {new Intl.NumberFormat().format(row.quantity)}
                    </TableCell>
